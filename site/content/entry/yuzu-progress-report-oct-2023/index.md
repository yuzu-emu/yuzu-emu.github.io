...
Hello yuz-ers! This past month we got a plethora of GPU fixes, support for new applets, a lot of work poured into the Android builds, some interesting stuff for the future, and more. Let’s get to it!
...
And for those asking, yes, Vulkan allows the use of a separate thread for rendering too–but we do it on an API level, instead of with a driver setting, so all GPUs can benefit.
